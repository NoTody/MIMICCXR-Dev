...
from utils import *
from utils import densenet_model, resnet_model, vit_model
...
def get_args():
    ...
    parser.add_argument("--pathology", type=str , choices=["Atelectasis", "Consolidation", "Effusion"] ,default="Atelectasis")
...
def main(args):
    ...
    TEST_IMAGE_LIST = f'{args.pathology}_test_list.txt'
